// AI Task List by educalvolpz — https://21st.dev/@educalvolpz/components/ai-task-list
// Fetched via the 21st.dev MCP connector; unmodified apart from this header.
"use client";
